    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger', models.CharField(max_length=10, unique=True)),
                ('entities', models.ManyToManyField(related_name='stories', to='tales.entity')),
                ('events', models.ManyToManyField(related_name='stories', to='tales.event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('story', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='room', to='tales.story')),
            ],
            options={
                'verbose_name': 'Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='tales.room')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atk', models.PositiveIntegerField(help_text='Maximum 20')),
                ('defense', models.PositiveIntegerField(help_text='Maximum 20')),
                ('actions', models.ManyToManyField(related_name='classes', to='tales.action')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('characterClass', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='characters', to='tales.characterclass')),
        ...
        migrations.CreateModel(
            name='Whisper',
            fields=[
                ('message', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='whisper', serialize=False, to='tales.message')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.ForeignKey(blank=True, help_text='Choose your player', null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='rooms', to='tales.character', verbose_name='Character')),
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants', to='tales.room')),
        ...
        migrations.CreateModel(
            name='Quote',
            fields=[
                ('message', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='quotes', serialize=False, to='tales.message')),
                ('quoted', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='messages_quoted', to='tales.message')),
            ],
        ),
        migrations.CreateModel(
            name='EntityInstance',
            fields=[
                ...
                ('entity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='instances', to='tales.entity')),
                ('room', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='instances', to='tales.room')),
            ],
            options={
