...
from blablapp.models import CharacterClass, Character, Action, MyUser, Contact,\
    Tickbox, Entity, EntityInstance, Event, Story, Room, RoomParticipant,\
    Message, Whisper, Quote
